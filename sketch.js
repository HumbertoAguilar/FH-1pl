...
var contador=60
var ball = Bodies.circle(500, 280, 20, {
render: {
  sprite: {
...
player1img=loadImage("3e23a0579a736f89912a7160f09a9b56.png")
player2img=loadImage("5620c526d191f3ae39951a0fb33e72c2.png")
...
pw1img=loadImage('9f22d48b09120d467ca75739c2474388.png')

pw2img=loadImage('b381b366e0b8517d58f736ba1c1ad146.png')
...
if(ball.position.x>800&&car2.position.y>265&&ball.position.y>290){
  ...
  Body.setVelocity( car2, {x:-5.5, y: 0});
  Matter.Body.setAngle(car2, 0)

}

if(ball.position.x<800&&car2.position.y>295&&ball.position.y>290&&ball.position.x>150){
  //Body.applyForce(car2.bodies[0],{x:car2.bodies[0].position.x, y:car2.bodies[0].position.y},{x:+0.03,y:0})
  Body.setVelocity( car2, {x:5.5, y: 0});
  Matter.Body.setAngle(car2, 0)
...
if(ball.position.y<290&& ball.position.y>276&&car2.position.y>305&&ball.position.x<800){
...
if(ball.position.x<250&&ball.position.y<180&&ball.position.x>200){
...
Body.setPosition(ball,{x:500, y:50})
...
function controls(){
  clickSound.play()
  location.replace('  https://humbertoaguilar.github.io/ControlsP1  ');
